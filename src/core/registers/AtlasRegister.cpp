...
// Linking function for blocks that are the covered cross model
void Atlas::covered_cross_linking(Block& block, std::string texture, std::string textureKey, float s, float t) {
    glm::vec2 texCoords;
